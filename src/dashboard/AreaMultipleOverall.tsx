...
const AreaMultipleOverall:  React.FC<Props> = ({ assessments, setSubjectAndAssignmentId, subjectAndAssignmentId, studentsTopics, viewing, setViewing}) => {
      ...
      <div className="col-span-12 rounded-sm border border-stroke bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-8">
        <div className="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
          <div className="flex w-full flex-wrap gap-3 sm:gap-5">
            ...
            <h4 className="text-xl font-semibold text-black dark:text-white">Overall Scores Over Time</h4>
...
export default AreaMultipleOverall;
