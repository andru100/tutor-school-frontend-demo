...
const SignUp: React.FC = () => {
  ...
  const signUp1 = async (Data: SignUpData) => {
    try {
      console.log("sending signupdata: ", Data);
  ...
  const handleGoogleSignUp = async (idToken: any) => {
    ...
    try{   
      ...
      const response = await fetch( serverAddress + '/registerGoogle', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      if (response.ok) {
        ...
        console.log("error in signup response is: ", errorData)
      }
    } catch (error) {
      console.error("Error during signup:", error);
      toast.error("An error occurred during signup. Please try again. If the problem persists, please contact support")
        ...
        <>
          <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div className="flex flex-wrap items-center">
              ...
              </h2> ipsum dolor sit amet, consectetur adipiscing elit
                    suspendisse.
                  </p>
