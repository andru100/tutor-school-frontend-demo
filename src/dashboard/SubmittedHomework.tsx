...
const SubmittedHomework: React.FC<Props> = ({homework, backToParent}) => {
          ...
          <tr className="bg-white dark:border-strokedark dark:bg-boxdark">
            ...
            <td className="py-5 px-4 dark:border-strokedark w-1/4">
              ...
              {role === 'Teacher' && (
                ...
                <button className="hover:text-primary" onClick={() => handleViewHomeworkStudio(event)} title='Resubmit homework'>
