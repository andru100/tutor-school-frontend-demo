...
import { Student } from '../dashboard/types'; // Import your data structures
import StatsNavigation from '../dashboard/StatsNavigation';
...
const TopicsHeatMapChart:  React.FC<Props> = ({ assessments, studentsTopics, setSubjectAndAssignmentId, subjectAndAssignmentId, viewing, setViewing}) => {
        ...
        <div className="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
          ...
          <div className="flex w-full flex-wrap gap-3 sm:gap-5">
            ...
            <div className="w-full">
              <h6 className="font-semibold text-black dark:text-white">Subject Topics</h6>
              <select 
                value={selectedTopic} 
...
export default TopicsHeatMapChart;
