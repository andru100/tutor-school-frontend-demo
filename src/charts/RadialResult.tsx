...
import { Student, StudentAssessmentAssignment, Score} from '../dashboard/types'; // Import your data structures
          ...
          <div className="mb-4 justify-between gap-4 sm:flex">
            <div className="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
              <div className="flex w-full flex-wrap gap-3 sm:gap-5">
                ...
                <h4 className="text-xl font-semibold text-black dark:text-white">Subject Scores</h4>
              </div>
            </div>
          </div>
          <div>
