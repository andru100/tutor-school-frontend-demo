...
const ScoresByTopicChart: React.FC<Props> = ({ assessments, studentsTopics, setSubjectAndAssignmentId, subjectAndAssignmentId, viewing, setViewing }) => {
...
export default ScoresByTopicChart;
