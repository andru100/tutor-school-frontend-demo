...
import CancelSignUpButton  from './CancelSignUpButton.tsx';
...
import {fetchTeacherData} from '/src/dashboard/FetchUserData.tsx'
import { UniversalContext } from '/src/context/UniversalContext.tsx';
import {Teacher} from '/src/dashboard/types.tsx'
...
const SignUpTeacher: React.FC = () => {
  const {setRole, setTeacherData}  = useContext(UniversalContext);
  ...
  const signUp = async (Data: AdminCreateTeacherData) => {
    try{
      ...
      const response = await fetch( serverAddress + "/api/account/signupteacher", {
        method: 'POST',
        headers: {
  ...
  const handleFormSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const signUpData: AdminCreateTeacherData = {
            ...
            <div className="flex flex-wrap items-center">
              ...
              <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                  <span className="mb-1.5 block font-medium">Almost there!</span>
                  <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                    Your Details
                  </h2>
                  ...
                  <form  onSubmit={(e)=>handleFormSubmit(e)}>
                    <div className="mb-4">
                      ...
                      <div className="relative">
                        ...
                        <span className="absolute right-4 top-4">
                          <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" height="22" viewBox="0 -960 960 960" width="22"><path d="M480-480q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47ZM160-160v-112q0-34 17.5-62.5T224-378q62-31 126-46.5T480-440q66 0 130 15.5T736-378q29 15 46.5 43.5T800-272v112H160Zm80-80h480v-32q0-11-5.5-20T700-306q-54-27-109-40.5T480-360q-56 0-111 13.5T260-306q-9 5-14.5 14t-5.5 20v32Zm240-320q33 0 56.5-23.5T560-640q0-33-23.5-56.5T480-720q-33 0-56.5 23.5T400-640q0 33 23.5 56.5T480-560Zm0-80Zm0 400Z"/></svg>
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <div className="relative">
                        ...
                        <span className="absolute right-4 top-4">
                        <svg className="fill-current" fill="none" xmlns="http://www.w3.org/2000/svg" height="22" viewBox="0 -960 960 960" width="22"><path d="M400-160h160v-40H400v40ZM280-40q-33 0-56.5-23.5T200-120v-720q0-33 23.5-56.5T280-920h400q33 0 56.5 23.5T760-840v720q0 33-23.5 56.5T680-40H280Zm0-200v120h400v-120H280Zm0-80h400v-400H280v400Zm0-480h400v-40H280v40Zm0 560v120-120Zm0-560v-40 40Z"/></svg>
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="relative">
                        ...
                        <span className="absolute right-4 top-4">
                        <svg className="fill-current" xmlns="http://www.w3.org/2000/svg" height="22" viewBox="0 -960 960 960" width="22"><path d="M320-240h320v-80H320v80Zm0-160h320v-80H320v80ZM240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h320l240 240v480q0 33-23.5 56.5T720-80H240Zm280-520v-200H240v640h480v-440H520ZM240-800v200-200 640-640Z"/></svg>
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="mt-6">
                    <div className="flex justify-between items-center">
                      <div>
                        <CancelSignUpButton className="w-full sm:w-auto" />
                      </div>
                      <div>
