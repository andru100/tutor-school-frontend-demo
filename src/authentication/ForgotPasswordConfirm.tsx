...
import ResendResetPasswordButton from './ResendResetPasswordButton.tsx'
...
const ForgotPasswordConfirm: React.FC = () => {
  ...
  const resetConfirm = async (resetPasswordRequest: ResetPasswordRequest) => {
    try {
      ...
      const response = await fetch( serverAddress + '/api/account/resetPassword', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        console.error("error in reset response is: ", errorData);
        toast.error("One or more of your details are incorrect. Please try again. (Account will be locked after 5 failed attempts)")
        //TODO handle lockout, advise locked out contact support or cool off.
      }
    } catch (error) {
      console.error("Error during reset confirmation:", error);
      toast.error("An error occurred during reset confirmation. Please try again.");
    }
  };
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Confirm your reset code.</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                ...
                <div className="mt-6 text-center">
                  <div className="mt-6 flex justify-between">
                    <div className="flex-1 text-center pr-2">
                      <ResendResetPasswordButton email={email} />
                    </div> 
