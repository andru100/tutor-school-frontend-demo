...
import ResendEmailConfirmButton from '/src/authentication/ResendEmailConfirmButton.tsx'
...
const ConfirmEmail: React.FC = () => {
  ...
  const confirmEmail = async (loginData: LoginData) => {
    ...
    try{
      ...
      console.error("Unexpected error in confirm email address:", error);
  ...
  const handleFormSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const confirmDetails = {
      email: email,
      code: formData.get('resetCode') as string,
    };
    confirmEmail(confirmDetails);
  };
