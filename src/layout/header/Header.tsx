...
const Header: React.FC<Props> = ({sidebarOpen, setSidebarOpen}) => {
  ...
  const showSearchInput = !(location.pathname === '/teacher-dashboard' || location.pathname === '/student-dashboard' || location.pathname === '/settings' || location.pathname === '/homework-studio');
      ...
      <div className="flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div className="hidden sm:block">
          <div className="relative">
            {showSearchInput && (
              <>
                <button className="absolute top-1/2 left-0 -translate-y-1/2" disabled>
                  <svg
